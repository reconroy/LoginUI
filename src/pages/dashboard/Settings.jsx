          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Show or hide the left sidebar</p>
              </div>
              <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out rounded-full">
                ...
                <label
                  ...
                  className={`block w-full h-full rounded-full cursor-pointer ${
                    isPrimarySidebarOpen ? 'bg-blue-600' : 'bg-gray-300'
                  }`}
                >
                  <span
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Show or hide the right sidebar</p>
              </div>
              <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out rounded-full">
                <input
                  type="checkbox"
                ...
                <label
                  ...
                  className={`block w-full h-full rounded-full cursor-pointer ${
                    isSecondarySidebarOpen ? 'bg-blue-600' : 'bg-gray-300'
                  }`}
                >
                  <span
                    className={`absolute left-0 w-6 h-6 transition-transform duration-200 ease-in-out transform bg-white rounded-full ${
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out rounded-full">
                ...
                <label
                  htmlFor="marketing"
                  className={`block w-full h-full rounded-full cursor-pointer ${
                    formData.marketing ? 'bg-blue-600' : 'bg-gray-300'
                  }`}
                >
                  <span
                    className={`absolute left-0 w-6 h-6 transition-transform duration-200 ease-in-out transform bg-white rounded-full ${
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out rounded-full">
                ...
                <label
                  htmlFor="updates"
                  className={`block w-full h-full rounded-full cursor-pointer ${
                    formData.updates ? 'bg-blue-600' : 'bg-gray-300'
                  }`}
                >
                  <span
                    className={`absolute left-0 w-6 h-6 transition-transform duration-200 ease-in-out transform bg-white rounded-full ${
